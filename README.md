...
We use monorepo to keep a package (@openbb/ui) and application (storybook) in the same repo and synced.
There's a tool that helps us to manage monorepos - [Turborepo](https://turbo.build/repo/docs).

Install it globally ([docs](https://turbo.build/repo/docs/getting-started/installation#global-installation)):
...
> **Important!** use [YARN 4](https://yarnpkg.com/getting-started/install#updating-yarn) to install dependencies. Npm and Bun doesn't work properly.
...
**Note:** If the story book is not working, use the following command and try again:
