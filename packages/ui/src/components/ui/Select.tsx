...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm p-1 pr-8 outline-none body-xs-regular",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      /* Light theme */
      "focus:bg-grey-50 focus:text-grey-750",
      /* Dark theme */
      "dark:focus:bg-dark-500 dark:focus:text-grey-100",
      className,
    )}
    {...props}
  >
